...
图片大于等于 40kb，会有性能问题，不建议使用太大的背景图，如开发者必须使用，则需自己将其转换为 base64格式使用，或将其挪到服务器上，从网络地址引用。
...
##### 43.Android平台隐私与政策提示框配置方法
[Android平台隐私与政策提示框配置方法](Android平台隐私与政策提示框配置方法)

##### 44.Android平台应用启动时读写手机存储、访问设备信息(如IMEI)等权限策略及提示信息
...
##### 46.uni-app 中使用 5+ 的原生界面控件（包括map、video、livepusher、barcode、nview）
